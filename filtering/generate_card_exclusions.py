...
def main() -> None:
    ...
    #for url in urls:
    scrape_card_search("https://pkmncards.com/?s=rarity%3Atrainer-gallery-holo-rare%2Ctrainer-gallery-holo-rare-v%2Ctrainer-gallery-ultra-rare%2Ctrainer-gallery-secret-rare%2Ctrainer-gallery-holo-rare-v-or-vmax&sort=date&ord=auto&display=images", save_folder)
